...
QT_MOC_LITERAL(3, 23, 10), // "closeEvent"
QT_MOC_LITERAL(4, 34, 12) // "QCloseEvent*"

    },
    "MainView\0windowClosed\0\0closeEvent\0"
    "QCloseEvent*"
};
...
void MainView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainView::windowClosed)) {
                *result = 0;
            }
        }
    }
...
void *MainView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QCloseEvent"))
        return static_cast< QCloseEvent*>(const_cast< MainView*>(this));
