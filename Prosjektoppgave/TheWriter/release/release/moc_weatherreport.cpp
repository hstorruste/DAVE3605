/****************************************************************************
** Meta object code from reading C++ file 'weatherreport.hpp'
**
...
#error "The header file 'weatherreport.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WeatherReport_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 44, 5) // "reply"
    ...
    "WeatherReport\0replyFinished\0\0"
...
void WeatherReport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WeatherReport *_t = static_cast<WeatherReport *>(_o);
        switch (_id) {
...
const QMetaObject WeatherReport::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WeatherReport.data,
      qt_meta_data_WeatherReport,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *WeatherReport::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WeatherReport.stringdata))
        return static_cast<void*>(const_cast< WeatherReport*>(this));
