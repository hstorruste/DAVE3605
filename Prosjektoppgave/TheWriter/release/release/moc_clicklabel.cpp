/****************************************************************************
** Meta object code from reading C++ file 'clicklabel.hpp'
**
...
#error "The header file 'clicklabel.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 20, 11) // "slotClicked"

    },
    "ClickLabel\0clicked\0\0slotClicked"
};
...
const QMetaObject ClickLabel::staticMetaObject = {
    { &ScaleLabel::staticMetaObject, qt_meta_stringdata_ClickLabel.data,
...
void *ClickLabel::qt_metacast(const char *_clname)
{
    ...
    return ScaleLabel::qt_metacast(_clname);
}

int ClickLabel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ScaleLabel::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
